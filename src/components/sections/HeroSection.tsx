...
const HERO_SLIDES: HeroSlide[] = [
    {
        ...
        eyebrow: "Global Sourcing & Supply Partner",
        titlePrefix: "Industrial &",
        titleHighlight: "Specialty",
        titleSuffix: "Chemicals",
    },
    {
        id: "chemicals-supply",
        image: "/images/home-background.jpeg",
        eyebrow: "Reliable Supply, Consistent Quality",
        titlePrefix: "Trusted B2B",
        titleHighlight: "Chemical",
        titleSuffix: "Sourcing Network",
    },
    {
        id: "chemicals-contract",
        image: "/images/v1-home-background.jpeg",
        eyebrow: "Domestic & International Supply",
