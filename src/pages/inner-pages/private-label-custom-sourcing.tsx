...
export default function PrivateLabelCustomSourcing() {
  ...
  return (
    <>
                        ...
                        <div className="pavanity-private-intro-top grid gap-6 xl:grid-cols-[minmax(0,1.12fr)_minmax(22rem,0.88fr)] xl:items-stretch">
                            <div className="pavanity-private-intro-panel">
                                ...
                                <p className="pavanity-private-intro-panel__copy mt-4 text-base md:text-lg">
                                    Kater International supports contract manufacturing coordination and custom product sourcing for B2B partners, distributors, and buyers. Our sourcing operations are structured to meet partner specifications, chemical quality standards, and market regulations.
                                </p>
                            </div>
        ...
        {/* ============================================ */}
        <div className="s-pb-100 bg-[#F8F8F9]">
