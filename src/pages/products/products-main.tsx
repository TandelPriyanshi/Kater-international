            ...
            <div className="container-fluid">
                ...
                <div className="pavanity-section-intro pavanity-products-section-intro mb-8 md:mb-12" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p className="mt-4 text-base md:text-lg">
                        Connecting B2B buyers with consistent chemical supplies, global sourcing networks, on-time exports, and contract manufacturing solutions through approved manufacturing partners.
                    </p>
                </div>
                ...
                <div className="max-w-3xl mx-auto mt-12 md:mt-16 text-center" data-aos="fade-up" data-aos-delay="500">
                    <div className="pavanity-cta-panel pavanity-products-cta-panel">
                        <h4 className="text-xl md:text-2xl font-semibold">
                            Looking for Specific Chemical Grades?
                        </h4>
                        <p className="mt-3 text-base md:text-lg">
                            We support custom product sourcing and contract manufacturing coordination for B2B buyers. Contact our sourcing team to discuss your requirements.
                        </p>
                        <Link
                            to="/contact"
